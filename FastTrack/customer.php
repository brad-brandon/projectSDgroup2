...
<header class="header-section">
    ...
    <div class="container-fluid">
        ...
        <div class="LoginSignup">
            <a href="./logout.php">
                <img src="img/logout.png" style="width: 200px; height: 40px; alt="LoginSignup Logo">
    ...
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            ...
            <div class="single-hero-item set-bg" data-setbg="img/homepage1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-text">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-text">
                        <h2>WELCOME TO Strength Training</h2>
                        <p class="short-details">Strength training uses resistance exercises to build muscle and improve fitness.</p>
                ...
                <div class="col-lg-6">
                    <div class="about-img">
                        <img src="img/strength.jpg" alt=""> <!-- need to edit this read more -->
                    </div>
                </div>
            </div>
        </div>
...
$conn = new mysqli($servername, $username, $password, $dbname);
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        ...
                        <p>Selecting the right pricing plan helps you to align your fitness journey to your needs and budget. </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-price-plan">
                        ...
                        <a href="membership.html" class="primary-btn price-btn">Get Started</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="single-price-plan">
                        ...
                        <ul>
                            ...
                            <li>Free drinking package</li>
                            <li>3 Free personal training</li>
                        </ul>
                        <a href="membership.html" class="primary-btn price-btn">Get Started</a>
                        <div class="tic-text">
                ...
                <div class="col-lg-4">
                    <div class="single-price-plan">
                        ...
                        <ul>
                            ...
                            <li>Free drinking package</li>
                            <li>Unlimited Free personal training</li>
                        </ul>
                        <a href="membership.html" class="primary-btn price-btn">Get Started</a>
                    </div>
                </div>
    ...
    <div class="map">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3983.6169155150246!2d101.72445221038878!3d3.194937596766887!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc37f5bdfa35a5%3A0xa1e339c137810a59!2sFastTrack%20Gym%20%26%20Fitness%20Centre!5e0!3m2!1sen!2smy!4v1724154358558!5m2!1sen!2smy" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <div class="map-contact-detalis">
            <div class="open-time">
                <h5>Weekday:</h5>
                <ul>
                    <li>Weekdays: <span>10:00 - 23:00</span></li>
                    <li>Saturday: <span>10:00 - 00:00</span></li>
                    <li>Sunday: <span>10:00 - 23:00</span></li>
                </ul>
            </div>
